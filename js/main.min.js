...
var fontActiveInterval;

function checkEventFontActive() {

	WebFont.load({
		google: {
			families: ['Montserrat', 'Kalam', 'Just Another Hand']
		},
		active: function() {
	...
	if(html.hasClass('wf-active')) clearInterval(fontActiveInterval);
...
$window.on('load', function() {
	...
	fontActiveInterval = setInterval(checkEventFontActive, 100);
...
var filterValue, grid = $('.product-gallery__imgs');
